...
static float time_counter = 0.0f; //全局时间计数
...
void cmdHandler(const std_msgs::Int16::ConstPtr& cmd){
  switch(cmd->data){
    ...
    case 21://gnss mode
        ...
        break;    
    case 109://路径 1
        path_id=1; time_counter = 0.0f;break;  
    case 110://路径 2
        path_id=2; time_counter = 0.0f;break;
    case 111://路径 3
        path_id=3; time_counter = 0.0f;break;      
    case 118://路径 4
        path_id=4; time_counter = 0.0f;break;    
    case 112://case 1
        enable_pos=1; break;
    case 113://case 2
        enable_pos=2; break;
...
void create_control(float dt) {
  ...
  switch (direction){
    case 1:
      circle_center.x += Linear_speed * dt;
      break;
    case 2:
      circle_center.x -= Linear_speed * dt;
      break;
    case 3:
      circle_center.y -= Linear_speed * dt;
      break;
    case 4:
      circle_center.y += Linear_speed * dt;
      break;
  ...
  uav[1].px = circle_center.x+3.0f;
  uav[1].py = circle_center.y;
  uav[1].pz = Hight;

  uav[2].px = circle_center.x+6.0f;
  uav[2].py = circle_center.y;
  uav[2].pz = Hight;
}
