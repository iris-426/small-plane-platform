...
if("TRUE" STREQUAL "TRUE")
  set(navi_multi_goals_pub_rviz_plugin_SOURCE_PREFIX /home/ubuntu/fcu_ws/src/fcu_core_rviz_swarm_goals_plugin)
  set(navi_multi_goals_pub_rviz_plugin_DEVEL_PREFIX /home/ubuntu/fcu_ws/devel)
  ...
  set(navi_multi_goals_pub_rviz_plugin_INSTALL_PREFIX /home/ubuntu/fcu_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navi_multi_goals_pub_rviz_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/fcu_ws/src/fcu_core_rviz_swarm_goals_plugin/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(navi_multi_goals_pub_rviz_plugin_EXPORTED_TARGETS ${${navi_multi_goals_pub_rviz_plugin_dep}_EXPORTED_TARGETS})
endforeach()
